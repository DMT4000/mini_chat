...
class WorkflowRouter:
    ...
    def detect_intent(self, question: str, user_facts: Dict[str, Any], conversation_context: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            # Quick detection for product recommendation intents
            product_keywords = [
                'lose weight', 'weight loss', 'diet', 'nutrition', 'supplement', 'vitamin',
                'protein', 'energy', 'health', 'wellness', 'fitness', 'muscle', 'fat',
                'detox', 'cleanse', 'immune', 'digestive', 'joint', 'stress', 'sleep'
            ]
            
            if any(keyword in lowered for keyword in product_keywords):
                return {"intent": "product_recommendation", "entities": {"category": "health_wellness"}, "needs_clarification": False}
